...
extension AppInfo {
    ...
    public nonisolated(unsafe) static var webserverPort = 6571
    ...
    public nonisolated(unsafe) static var isChinaEdition: Bool = {
    ...
    public nonisolated(unsafe) static var appStoreId = "id670881887"
