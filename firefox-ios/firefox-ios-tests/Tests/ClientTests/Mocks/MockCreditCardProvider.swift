...
// Ecosia: Added from upstream v147.5 so CreditCardInputViewModelTests can drive the view model through a mock
// CreditCardProvider instead of a real RustAutofill DB. Writing to the real autofill DB (encryption/Rust) crashed
// the save/update/remove tests; the mock makes them deterministic and crash-free. (MOB-4384)
