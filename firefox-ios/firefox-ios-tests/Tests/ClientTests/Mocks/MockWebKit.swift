...
// MARK: WKWebViewMock
// MARK: MockWKWebView
// Ecosia: upstream renamed this to `MockWKWebView`; the alias keeps Ecosia's existing
// `WKWebViewMock` call sites (and WKFrameInfoMock.new's parameter type) compiling.
typealias WKWebViewMock = MockWKWebView
