...
public class Auth {
    ...
    /**
     ...
     This method performs a complete logout by clearing both the Auth0 session and locally stored credentials.
     It also triggers a web logout to ensure the user is logged out from all contexts.
     
     - Note: This method will update the `isLoggedIn` property to `false` and clear all credential properties
