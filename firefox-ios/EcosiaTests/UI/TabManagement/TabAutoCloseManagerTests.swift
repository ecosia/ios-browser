...
/*
 ...
 variant we must override. The `(Tab, completion:)` variant that used to be overridden here as well
 was removed from `TabManager` in 155.1, so the override is gone with it.
 */
