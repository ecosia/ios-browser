...
public enum Packages {
    public static let all: [Package] = [
        ...
        .remote(url: "https://github.com/mozilla/glean-swift.git", requirement: .upToNextMinor(from: "69.0.0")),
        ...
        .remote(url: "https://github.com/onevcat/Kingfisher.git", requirement: .exact("8.11.0")),
        .remote(url: "https://github.com/apple/swift-certificates.git", requirement: .exact("1.2.0")),
        .remote(url: "https://github.com/WilhelmOks/ModifiedCopyMacro.git", requirement: .exact("2.2.0")),
