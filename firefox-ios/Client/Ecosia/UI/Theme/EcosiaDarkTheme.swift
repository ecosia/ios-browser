...
private struct EcosiaDarkSemanticColors: EcosiaSemanticColors {
    ...
    var backgroundFeatured: UIColor = EcosiaColor.Grellow700
    var backgroundGradient: UIColor = EcosiaColor.Gray90
    ...
    var backgroundTertiary: UIColor = EcosiaColor.Gray80
    ...
    var brandImpact: UIColor = EcosiaColor.Yellow200
    ...
    var buttonBackgroundSecondary: UIColor = EcosiaColor.Gray80
    ...
    var iconDecorative: UIColor = EcosiaColor.Gray40
    var iconInverseStrong: UIColor = EcosiaColor.Gray70
    ...
    var stateError: UIColor = EcosiaColor.Red300
    ...
    var textInversePrimary: UIColor = EcosiaColor.Gray70
