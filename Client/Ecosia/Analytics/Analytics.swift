...
//    private var tracker: SnowplowTracker.Tracker?

    private init() {
//        tracker = Snowplow.setup(remoteConfiguration: <#T##RemoteConfiguration#>, defaultConfiguration: <#T##[ConfigurationBundle]?#>, onSuccess: <#T##([String]?) -> Void#>)
//
//        tracker = .build {
...
//        guard let subject = Subject(platformContext: true, andGeoContext: true) else { return }
//        subject.setUserId(User.shared.analyticsId.uuidString)
