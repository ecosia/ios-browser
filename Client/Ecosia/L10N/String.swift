...
extension String {
    ...
    enum Key: String {
        ...
        case allOurProfitsGo = "All our profits go to climate action, including planting trees and generating solar energy."
        ...
        case wellNeverSell = "We'll never sell your details to advertisers or create a profile of you."
        case skip = "Skip"
