...
extension String {
    ...
    enum Key: String {
        ...
        case checkThisOut = "Check this out: Ecosia plants trees every time you search the web! 🌳 Join me and 20M+ others and start planting today."
        case downloadTheApp = "1. Download the app:"
        case useMyInviteLink = "2. Use my ✨ invite link ✨ and we will both plant an extra tree 🌳(Android coming soon):"
