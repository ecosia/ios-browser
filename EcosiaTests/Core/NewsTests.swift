...
final class NewsTests: XCTestCase {
    ...
    private func mockSavedItems() {
        let items = [
            NewsModel(id: 1, text: "", language: .en, publishDate: .distantPast,
                      imageUrl: URL(string: "https://avocade.com")!, targetUrl: URL(string: "https://avocadoe.com")!, trackingName: ""),
            NewsModel(id: 2, text: "hello", language: .en, publishDate: .distantFuture,
                      imageUrl: URL(string: "https://guacamole.com")!, targetUrl: URL(string: "https://guaca.com")!, trackingName: ""),
            NewsModel(id: 3, text: "hello", language: .de, publishDate: .distantFuture,
                      imageUrl: URL(string: "https://guacamole.com")!, targetUrl: URL(string: "https://guaca.com")!, trackingName: "")
        ]
    ...
    func testAvoidDuplication() {
        var set = Set([NewsModel(id: 1, text: "<strong>Great headline</strong> ", language: .en, publishDate: .distantPast,
                                         imageUrl: URL(string: "https://avocade.com")!, targetUrl: URL(string: "https://avocadoe.com")!, trackingName: "")])
        set.insert(NewsModel(id: 1, text: "hello", language: .de, publishDate: .distantFuture,
                                     imageUrl: URL(string: "https://guacamole.com")!, targetUrl: URL(string: "https://guaca.com")!, trackingName: ""))
