...
class SingularServiceTests: XCTestCase {
    ...
    let failureResponseMock = HTTPURLResponse(url: URL(string: "https://www.example.com")!,
                                              statusCode: 404, httpVersion: nil, headerFields: nil)
    let successResponseMock = HTTPURLResponse(url: URL(string: "https://www.example.com")!,
    ...
    override func setUpWithError() throws {
        ...
        let deviceInfo = AppDeviceInfo(platform: "a", bundleId: "b", osVersion: "c", deviceManufacturer: "d", deviceModel: "e", locale: "f", country: "g", appVersion: "h")
        sessionInfoRequestMock = SingularSessionInfoSendRequest(identifier: "123", info: deviceInfo, skanParameters: ["something": "test"])
        eventRequestMock = SingularEventRequest(identifier: "123", name: "some-event", info: deviceInfo)
        conversionValueRequestMock = SingularConversionValueRequest(.init(identifier: "123", eventName: "c", appDeviceInfo: deviceInfo), skanParameters: ["something": "test"])
